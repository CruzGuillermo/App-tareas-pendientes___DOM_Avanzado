...
function addToDo() {
  // Tu código acá:
  let input = document.querySelector("#toDoInput") //input = ""
    if(input.value){
      let nuevoToDo = new ToDo(input.value) //sacar la basura
...
function completeToDo(event) {
  ...
  //toDoItems[1]--> {description: "pasear el perro", complete:true}
  displayToDos();
}
